...
base_model_name = directoryM+"Qwen/Qwen2-0.5B-Instruct"

# La cartella dove hai salvato i tuoi adattatori LoRA dal training a 16-bit
adapter_path = directoryM+"qwen2-finetuned-soprannomi-16bit"

# La cartella dove salvare il modello finale unito
output_dir = directoryM+"modello-unito-soprannomi-16bit"
